...
function ProfileChange({ updateTrigger, setUpdateTrigger, closeModal }) {
    ...
    const handleProfileSubmit = async (e) => {
        ...
        try {
            ...
            if (!response.ok) {
                throw new Error(responseData.message || 'Failed to update profile image');
            }
    ...
    return (
        <form onSubmit={handleProfileSubmit} className="flex flex-col gap-6 max-w-md mx-auto">
            {/* Error Message */}
            {error && (
